--- chrome/app/chrome_main_delegate.cc.orig	2019-09-09 21:55:07 UTC
...
@@ -648,7 +648,7 @@ bool ChromeMainDelegate::BasicStartupComplete(int* exi
     *exit_code = 0;
...
+#if (defined(OS_LINUX) && !defined(OS_CHROMEOS)) || defined(OS_BSD)
 ...
 #endif
@@ -672,7 +672,7 @@ bool ChromeMainDelegate::BasicStartupComplete(int* exi
...
@@ -866,7 +866,7 @@ void ChromeMainDelegate::PreSandboxStartup() {
 #if defined(OS_WIN)
...
+#if defined(ARCH_CPU_ARM_FAMILY) && (defined(OS_ANDROID) || defined(OS_LINUX) || defined(OS_BSD))
   ...
   // cpu_brand info.
   base::CPU cpu_info;
@@ -994,7 +994,7 @@ void ChromeMainDelegate::PreSandboxStartup() {
   InitializePDF();
 #endif
...
@@ -1009,7 +1009,7 @@ void ChromeMainDelegate::PreSandboxStartup() {
...
@@ -1019,7 +1019,7 @@ void ChromeMainDelegate::PreSandboxStartup() {
