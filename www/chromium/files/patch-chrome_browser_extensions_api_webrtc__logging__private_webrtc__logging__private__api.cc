--- chrome/browser/extensions/api/webrtc_logging_private/webrtc_logging_private_api.cc.orig	2019-09-09 21:55:09 UTC
...
@@ -587,11 +587,11 @@ bool WebrtcLoggingPrivateGetLogsDirectoryFunction::Run
