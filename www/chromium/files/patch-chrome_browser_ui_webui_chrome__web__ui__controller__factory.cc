--- chrome/browser/ui/webui/chrome_web_ui_controller_factory.cc.orig	2019-09-09 21:55:11 UTC
...
+#if (defined(OS_LINUX) && defined(TOOLKIT_VIEWS)) || defined(USE_AURA) || defined(OS_BSD)
 ...
 #endif
@@ -676,17 +676,17 @@ WebUIFactoryFunction GetWebUIFactoryFunction(WebUI* we
