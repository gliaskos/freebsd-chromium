--- third_party/WebKit/Source/platform/fonts/Character.cpp.orig	2016-05-20 18:25:40 UTC
...
+static bool hasProperty(UChar32 c, CharacterProperty property)
 {
     ...
     if (!trie)
@@ -68,6 +99,10 @@ bool Character::hasProperty(UChar32 c, C
...
@@ -184,7 +219,7 @@ CodePath Character::characterRangeCodePa
...
@@ -193,7 +228,7 @@ bool Character::isCJKIdeographOrSymbol(U
     if (c < 0x2C7)
         return false;
