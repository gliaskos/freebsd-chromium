--- ui/views/controls/textfield/textfield.cc.orig	2019-09-09 21:55:47 UTC
...
@@ -164,14 +164,14 @@ ui::TextEditCommand GetCommandForKeyEvent(const ui::Ke
     case ui::VKEY_BACK:
       if (!control)
...
@@ -239,7 +239,7 @@ bool IsControlKeyModifier(int flags) {
...
+#if (defined(OS_LINUX) || defined(OS_BSD)) && !defined(OS_CHROMEOS)
   ...
   ui::TextEditKeyBindingsDelegateAuraLinux* delegate =
       ui::GetTextEditKeyBindingsDelegate();
@@ -2111,7 +2111,7 @@ bool Textfield::PasteSelectionClipboard() {
 }
