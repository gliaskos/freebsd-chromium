--- remoting/host/remoting_me2me_host.cc.orig	2019-09-09 21:55:22 UTC
...
+#if defined(OS_LINUX) || defined(OS_BSD)
 ...
 #endif
@@ -554,10 +554,10 @@ bool HostProcess::InitWithCommandLine(const base::Comm
...
+#endif  // defined(OS_LINUX) || defined(OS_WIN) || defined(OS_BSD)
     ...
     uint32_t window_id;
@@ -752,7 +752,7 @@ void HostProcess::CreateAuthenticatorFactory() {
...
@@ -838,7 +838,7 @@ void HostProcess::StartOnUiThread() {
...
@@ -902,7 +902,7 @@ void HostProcess::ShutdownOnUiThread() {
...
@@ -1531,7 +1531,7 @@ void HostProcess::StartHost() {
...
@@ -1710,7 +1710,7 @@ void HostProcess::OnCrash(const std::string& function_
 int HostProcessMain() {
