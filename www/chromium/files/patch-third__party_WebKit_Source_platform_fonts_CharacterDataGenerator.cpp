--- third_party/WebKit/Source/platform/fonts/CharacterDataGenerator.cpp.orig	2016-05-20 17:52:31 UTC
+++ third_party/WebKit/Source/platform/fonts/CharacterDataGenerator.cpp
@@ -2,228 +2,27 @@
...
@@ -250,7 +49,7 @@ static void setValues(CharacterProperty*
     }
 }
...
+static void generateUTrieSerialized(FILE* fp, int32_t size, uint8_t* array)
 {
     fprintf(fp,
         "#include <cstdint>\n\n"
@@ -267,31 +66,21 @@ static void generate(FILE* fp, int32_t s
         "} // namespace blink\n");
 }
