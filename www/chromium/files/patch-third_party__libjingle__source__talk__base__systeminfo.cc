--- ./third_party/libjingle/source/talk/base/systeminfo.cc.orig	2014-07-15 21:04:16.000000000 +0200
+++ ./third_party/libjingle/source/talk/base/systeminfo.cc	2014-07-20 18:13:09.000000000 +0200
@@ -36,8 +36,12 @@
 #elif defined(OSX)
